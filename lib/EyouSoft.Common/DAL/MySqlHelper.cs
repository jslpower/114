...
namespace EyouSoft.Common.DAL
{
    ...
    public abstract class MySqlHelper : IDisposable
    {
        ...
        /// 数据库链接
        /// </summary>
         protected static readonly string connectionString = EyouSoft.Common.EncryptUtility.ConnectionInfo.DecryptDbConnStr(EyouSoft.Common.ConfigModel.ConfigClass.GetConnectionString("MysqlDbString"));
        ...
        /// <returns></returns>
        public static bool IsExists(string strSql, params MySqlParameter[] cmdParms)
        {
        ...
        public static void ExecuteSqlTran(ArrayList SQLStringList)
        {
            ...
            {
                conn.Open();
                using (MySqlTransaction mytransaction = conn.BeginTransaction())
                {
                    try
                    {
        ...
        public static DataTable DataTableQuery(string strSql)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
        ...
        /// </summary>
        /// <param name="strSql">查询语句</param>
        /// <param name="cmdParms">传参</param>
        /// <returns>DataTable</returns>
        public static DataTable DataTableQuery(string strSql, params MySqlParameter[] cmdParms)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                MySqlCommand cmd = new MySqlCommand();
