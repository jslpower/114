...
namespace WEB
{
    public partial class meituapp : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            if (GetInt(Request.Form["t"]) == 1)
            {
                string cookies = string.Empty;
                string s = create("http://4.app.meitu.com/mkimg.php", string.Empty, Method.POST, "username=" + Request.Form["name"], ref cookies, false);
