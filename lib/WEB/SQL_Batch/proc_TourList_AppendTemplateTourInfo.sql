...
ALTER PROCEDURE proc_TourList_AppendTemplateTourInfo
	...
	@InsertChildren NVARCHAR(MAX),--要添加的子团信息 XML:<ROOT><TourInfo TourId="团队编号 CHAR(36)" TourCode="团号 NVARCHAR(200)" LeaveDate="出团日期 DATETIME"></ROOT>
