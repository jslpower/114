...
-- =============================================
ALTER PROCEDURE proc_TourList_UpdateTourInfo
	@TourId CHAR(36),--团队编号
...
BEGIN
	...
	BEGIN
		...
		FROM OPENXML(@hdoc,'/ROOT/PlanInfo') WITH(PlanInterval NVARCHAR(50),Vehicle NVARCHAR(50),TrafficNumber NVARCHAR(50),House NVARCHAR(50),Dinner NVARCHAR(50),PlanContent NVARCHAR(2000),PlanDay INT,PlanId CHAR(36)) AS A
		EXECUTE sp_xml_removedocument @hdoc
