...
namespace EyouSoft.IDAL.ToolStructure
{
    ...
    public interface ICompanyFileUpload
    {
        ...
        int Add(EyouSoft.Model.ToolStructure.CompanyFileUpload model);
        ...
        /// <returns>操作结果</returns>
        int UpdateName(string FileId, string FileName);
        ...
        /// <returns>操作结果</returns>
        int MoveFile(string FileId, string FolderId);
        ...
        /// <param name="FileId">文件编号</param>
        /// <returns>操作结果</returns>
        int RemoveFolder(string FileId);
        ...
        /// <param name="FolderId">目录编号</param>
        /// <returns>操作结果</returns>
        int RemoveFile(string FileId, string FolderId);
