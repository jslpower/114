...
namespace EyouSoft.IDAL.CompanyStructure
{
    ...
    public interface ISupplierInfo
    {
        ...
        /// <returns>true:成功 false:失败</returns>
        bool Update(string CompanyId, string CompanyName, string Remark, string ShortRemark);
        /// <summary>
        /// 设置供应商相关附件（企业宣传图，产品展示图片）
        /// </summary>
        /// <param name="CompanyId">公司编号</param>
        /// <param name="CompanyLogo">公司宣传图</param>
        /// <param name="CompanyLogoThumb">公司宣传图缩略图</param>
        /// <param name="list">产品附件集合</param>
        /// <returns>true:成功 false:失败</returns>
        bool SetProduct(string CompanyId, string CompanyImg, string CompanyImgThumb, IList<EyouSoft.Model.CompanyStructure.ProductInfo> list);
        /// <summary>
        /// 分页获取供应商列表
        /// </summary>
