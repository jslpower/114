...
namespace EyouSoft.IBLL.SMSStructure
{
    ...
    public interface IAccount
    {
        ...
        /// <param name="companyId">公司编号</param>
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.PayMoneyInfo> GetPayMoneys(int pageSize, int pageIndex, ref int recordCount, string companyId);
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.PayMoneyInfo> GetPayMoneys(int pageSize, int pageIndex, ref int recordCount, string companyName, DateTime? payTime, int? provinceId, int? cityId, int checkStatus);
        ...
        /// <param name="checkStatus">审核状态 -1:所有状态 0:未审核 1:审核通过  2:审核未通过</param>
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.PayMoneyInfo> GetPayMoneys(int pageSize, int pageIndex, ref int recordCount, string companyId, string companyName, DateTime? payStartTime, DateTime? payFinishTime, DateTime? operatorStartTime, DateTime? operatorFinishTime, int? provinceId, int? cityId, int checkStatus);*/
        ...
        /// </remarks>
        [CommonLogHandler(
            LogTitle = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_CheckPayMoney_Title,
            LogMessage = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_CheckPayMoney,
            LogWriterType = typeof(EyouSoft.BusinessLogWriter.WebMasterLog),
            LogAttribute = @"[{""Index"":0,""Attribute"":""PayMoneyId"",""AttributeType"":""class""}]",
            EventCode = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_CheckPayMoney_CODE)]
        ...
        /// <returns></returns>
        [CommonLogHandler(
            LogTitle = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_DeleteNoPassCheckPayMoney_Title,
            LogMessage = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_DeleteNoPassCheckPayMoney,
            LogWriterType = typeof(EyouSoft.BusinessLogWriter.WebMasterLog),
            LogAttribute = @"[{""Index"":0,""Attribute"":""PayMoneyId"",""AttributeType"":""val""}]",
            EventCode = EyouSoft.BusinessLogWriter.WebMasterLog.LOG_SMS_DeleteNoPassCheckPayMoney_CODE)]
        ...
        /// <returns></returns>
        IList<EyouSoft.Model.SMSStructure.AccountDetailInfo> RemnantStats(int pageSize, int pageIndex, ref int recordCount, int? provinceId, int? cityId, string companyName);
    }
}
