...
namespace EyouSoft.IBLL.ToolStructure
{
    ...
    public interface IReceivables
    {
        ...
        /// <returns></returns>
        [CommonLogHandler(
            LogTitle = EyouSoft.BusinessLogWriter.CompanyLog.LOG_RECEIVABLES_ADD_TITLE,
            LogMessage = EyouSoft.BusinessLogWriter.CompanyLog.LOG_RECEIVABLES_ADD,
            ...
            EventCode = EyouSoft.BusinessLogWriter.CompanyLog.LOG_RECEIVABLES_ADD_CODE)]
