...
namespace EyouSoft.IBLL.SystemStructure
{
    ...
    public interface ISysApplyService
    {
        ...
        int EshopRenewed(string applyId, DateTime enableTime, DateTime expireTime, int operatorId, DateTime renewTime);
        ...
        /// <returns>1:成功 0:失败 2:续费时间不对</returns>
        int MQRenewed(string applyId, DateTime enableTime, DateTime expireTime, int operatorId, DateTime renewTime,int subAccountNumber);
