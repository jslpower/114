...
namespace EyouSoft.IBLL.SystemStructure
{
    ...
    public interface ISysCompanyDomain
    {
        ...
        bool SetDisabled(int DomainId, bool IsDisabled);
        ...
        bool SetDisabled(string CompanyId, DomainType domainType, bool IsDisabled);
        ...
        IList<EyouSoft.Model.SystemStructure.SysCompanyDomain> GetDomainList(params string[] CompanyId);
