...
namespace EyouSoft.IBLL.ShopStructure
{
    ...
    public interface IHighShopAdv
    {
        ...
        [CommonLogHandler(
        LogTitle = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopAdv_INSERT_TITLE,
        LogMessage = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopAdv_INSERT,
        LogWriterType = typeof(EyouSoft.BusinessLogWriter.ServiceLog),
        LogAttribute = @"[{""Index"":0,""Attribute"":""CompanyID"",""AttributeType"":""val""}]",
        EventCode = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopAdv_INSERT_CODE)]
