...
namespace EyouSoft.IBLL.ShopStructure
{
    ...
    public interface IHighShopTripGuide
    {
        ...
        [CommonLogHandler(
      LogTitle = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_INSERT_TITLE,
      LogMessage = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_INSERT,
      LogWriterType = typeof(EyouSoft.BusinessLogWriter.ServiceLog),
      LogAttribute = @"[{""Index"":0,""Attribute"":""ID"",""AttributeType"":""class""}]",
      EventCode = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_INSERT_CODE)]
        ...
        /// <returns>false:失败 true:成功</returns>
        [CommonLogHandler(
     LogTitle = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_UPDATE_TITLE,
     LogMessage = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_UPDATE,
     LogWriterType = typeof(EyouSoft.BusinessLogWriter.ServiceLog),
     LogAttribute = @"[{""Index"":0,""Attribute"":""ID"",""AttributeType"":""class""}]",
     EventCode = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_UPDATE_CODE)]
        ...
        /// <returns>false:失败 true:成功</returns>
        [CommonLogHandler(
     LogTitle = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_DELETE_TITLE,
     LogMessage = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_DELETE,
     LogWriterType = typeof(EyouSoft.BusinessLogWriter.ServiceLog),
     LogAttribute = @"[{""Index"":0,""Attribute"":""ID"",""AttributeType"":""val""}]",
     EventCode = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_DELETE_CODE)]
        ...
        /// <returns>false:失败 true:成功</returns>
        [CommonLogHandler(
     LogTitle = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_SETTOP_TITLE,
     LogMessage = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_SETTOP,
     LogWriterType = typeof(EyouSoft.BusinessLogWriter.ServiceLog),
     LogAttribute = @"[{""Index"":0,""Attribute"":""ID"",""AttributeType"":""val""},{""Index"":1,""Attribute"":""IsTop"",""AttributeType"":""val""}]",
     EventCode = EyouSoft.BusinessLogWriter.ServiceLog.LOG_HighShopTripGuide_SETTOP_CODE)]
