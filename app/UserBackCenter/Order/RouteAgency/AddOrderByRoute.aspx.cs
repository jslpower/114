...
{
    public partial class AddOrderByRoute : BackPage
    {
        /// <summary>
        /// 容器ID
        /// </summary>
        ...
        {
            if (!SiteUserInfo.CompanyRole.HasRole(CompanyType.专线))
            {
                Response.Clear();
        ...
        private string FormSave()
        {
            ...
            orderModel.TotalSalePrice = adultCount * reAdultPrice + childCount * reChilePrice + otherCount * reOtherPrice;
            orderModel.TotalSettlementPrice = adultCount * seAdultPrice + childCount * seChildPrice + addReduction;
