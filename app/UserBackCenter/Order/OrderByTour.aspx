<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OrderByTour.aspx.cs" Inherits="UserBackCenter.Order.OrderByTour" %>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    ...
                                    <strong>当前剩余空位：<asp:label runat="server" text="" id="lblCount"></asp:label></strong>&nbsp;&nbsp;
                                    <strong>状态：<asp:label runat="server" text="" id="lblTourState"></asp:label>
                                    </strong>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <asp:label runat="server" text="" id="lblLeaveCityandTraffic"></asp:label>
                                    <strong>出发航班:</strong>
                                    <asp:Label runat="server" id="lbLeavedate" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#F2F9FE" align="right">
                                ...
                                <td align="left">
                                    <asp:label runat="server" text="" id="lblEndCityandTraffic"></asp:label>
                                    <strong>返程航班:</strong>
                                    <asp:Label runat="server" id="lbEnddate" Text=""></asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#F2F9FE" align="right">
                            ...
                            <tr>
                                ...
                                <td align="left">
                                    <textarea rows="4" cols="85" id="txtCusRemark" runat="server"></textarea>
                                </td>
                            </tr>
                            <tr>
                                <td bgcolor="#F2F9FE" align="right">
...
<script type="text/javascript">
    var OrderByTour = {
        ...
        SubmitForm: function(ref) {
            ...
            $.newAjax({
                type: "POST",
                url: "/Order/OrderByTour.aspx?tourID=<%=Request.QueryString["tourID"] %>&dotype=save&v=" + Math.random(),
                data: obj.find("[id$=btnSave]").closest("form").serialize(),
                cache: false,
                success: function(state) {
                    if (state == "ok") {
                        alert("订单提交成功!");
                        obj.find("[id$=btnSave]").remove();
                        topTab.url(topTab.activeTabIndex, "/teamservice/fitorders.aspx");
                    } else {
                        alert(state);
