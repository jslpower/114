<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MQEditOrder.aspx.cs" Inherits="UserBackCenter.UserOrder.MQEditOrder" %>
...
<body>
    ...
    <input id="hidRemnantNumber" name="hidRemnantNumber" value="<%=RemnantNumber %>"
        type="hidden" />
    <table width="770" border="0" align="center" cellpadding="0" cellspacing="0" style="margin-top: 30px;">
        <tr>
            <td width="261">
                <img src="<%=ImageServerUrl %>/images/tstop1.gif" width="261" height="44" />
            </td>
            <td width="302" align="center" background="<%=ImageServerUrl %>/images/tstopbj.gif">
                <a href="<%=EyouSoft.Common.Domain.UserBackCenter + "/Default.aspx" %>" target="_blank">
                    进入系统后台</a>
            </td>
            <td width="207" align="center" background="<%=ImageServerUrl %>/images/tstopbj.gif">
                <a href="<%=EyouSoft.Common.Domain.UserPublicCenter + "/Default.aspx" %>" target="_blank">
                    返回同业114首页</a>
            </td>
        </tr>
    </table>
    <table width="750" border="0" align="center" cellpadding="0" cellspacing="0">
        <tr>
            <td style="border: 1px solid #C2D7DB; border-top: 0px; width:750px; padding:10px; background: #F5FAFB;">
                    ...
                    <ItemTemplate>
                        <table width="750" border="0" cellspacing="0" cellpadding="6">
                            <tr>
                                ...
                                <td width="68%" align="left" class="td2left">
                                    <a href="/PrintPage/TeamInformationPrintPage.aspx?TourID=<%#Eval("TourID") %>" target="_blank">
                                ...
                                <td width="15%" align="left" class="td2left">
                                    <a href="/PrintPage/TourConfirmation.aspx?TourID=<%#Eval("TourID") %>&OrderID=<%#Eval("id") %>"
                                        target="_blank">
                                        <img src="<%=ImageServerUrl %>/images/active_ico_print.gif" width="19" height="16"
                                            style="margin-bottom: -3px;" />确认单打印</a>
                                </td>
                            </tr>
                            <tr>
                                <td width="15%" align="right" class="tdleft">
                                            ...
                                            <td>
                                                ...
                                                成人数<input type="text" value="<%#Eval("AdultNumber") %>" valid="required|RegInteger"
                                                    ...
                                                    style="border: 1px solid #7F9DB9; width: 22px;" />×单价<input name="PersonalPrice"
                                                        ...
                                                        style="border: 1px solid #7F9DB9; width: 40px;" /><span style="font-size: 20px; color: #cc0000;">+</span>儿童数<input
                                                            name="ChildNumber" valid="required|RegInteger" errmsg="请填写儿童数!|儿童数只能整数,请输入整数!"
                                                            maxlength="3" type="text" value="<%#Eval("ChildNumber") %>" onchange="EditOrder.createTr(this,0)"
                                                            size="2" style="border: 1px solid #7F9DB9; width: 22px;" />×单价<input name="ChildPrice"
                                                                type="text" valid="required|isNumber" errmsg="请填写儿童价!|儿童价只能是数字,请输入数字!" value="<%#Eval("ChildPrice","{0:F2}")%>"
                                                                size="4" style="border: 1px solid #7F9DB9;" /><span style="font-size: 20px; color: #cc0000;">+</span>单房差<input
                                                                    name="MarketNumber" type="text" value="<%#Eval("MarketNumber") %>" valid="required|RegInteger"
                                                                    errmsg="请填写单房差!|单房差只能整数,请输入整数!" size="2" style="border: 1px solid #7F9DB9;" />×单价<input
                                                                        name="MarketPrice" type="text" valid="required|isNumber" errmsg="请填写单房差单价!|单房差单价只能是数字,请输入数字!"
                                                                        value="<%#Eval("MarketPrice","{0:F2}") %>" style="border: 1px solid #7F9DB9;
                                                                        width: 40px;" />
                                                <span style="font-size: 20px; color: #cc0000;">+</span>其它费用
                                                <input name="OtherPrice" type="text" valid="required|isNumber" errmsg="请填写其它费用!|其它费用只能是数字,请输入数字!"
                                                    value="<%#Eval("OtherPrice","{0:F2}") %>" size="4" style="border: 1px solid #7F9DB9;
                                                    width: 40px;" />
                                            </td>
                                        </tr>
                                    </table>
                            ...
                            <tr>
                                ...
                                <td colspan="2" align="left" class="td2left">
                                    <textarea name="SpecialContent" id="txtSpecialContent" style="width: 500px; overflow:auto;" cols="80"
                        ...
                        <table width="750" border="0" cellpadding="3" cellspacing="0" bgcolor="#FEF7CD"
                            style="border: 1px solid #D8BC81; margin-top: 8px;">
                            <tr>
                ...
                <table>
                    <tr runat="server" id="TrOrderOperatorContainer">
                        <td align="right">
                            <strong>订单处理操作：</strong>
                        </td>
                        <td align="left">
                            &nbsp;<%if (isGrant)
                                    { %>
                ...
                <table id="tblCustomerList" cellspacing="1" cellpadding="0" width="750" align="center"
                    bgcolor="#93B5D7" border="0">
                    <tr bgcolor="#f9f9f4">
