<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleFileUpload.ascx.cs" Inherits="Demo1.usercontrol.SingleFileUpload" %>
		   ...
		   //alert("<%=this.ClientID %>");
			    <%=this.ClientID %> = new SWFUpload({
                    ...
                    post_params : {
                        ...
                        "ThemImageWidth":"<%=ThemImageWidth %>",
                        "ThemImageHeight":"<%=ThemImageHeight %>",
                        "IsGenerateThumbnail":"<%=IsGenerateThumbnail?1:0 %>",
				    ...
				    button_width: 160,
				    button_height: 22,
				    button_text : '<span class="button">选择图像文件<span class="buttonSmall">(最大2 MB)</span></span>',
