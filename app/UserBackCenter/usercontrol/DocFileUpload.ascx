<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DocFileUpload.ascx.cs" Inherits="UserBackCenter.usercontrol.DocFileUpload" %>
		...
		//$(function () {
		   //alert("<%=this.ClientID %>");
			    <%=this.ClientID %> = new SWFUpload({
				    ...
				    button_width: 160,
				    button_height: 22,
				    button_text : '<span class="button">选择要上传的文件<span class="buttonSmall">(最大2 MB)</span></span>',
