<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetNewsList.aspx.cs" Inherits="UserBackCenter.EShop.SetNewsList" %>
...
<body>
        ...
        <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin:3px 0 3px 0;">
          <tr>
            ...
            <td width="113" height="25" background="<%=ImageManage.GetImagerServerUrl(1)%>/Images/seniorshop/quanziyqupc.gif" align="center">
                <a href="SetNews.aspx">最新动态添加</a></td>
            <td width="113" height="25" background="<%=ImageManage.GetImagerServerUrl(1)%>/Images/seniorshop/quanziyqonc.gif"  align="center"><a href="SetNewsList.aspx">
                最新动态列表</a></td>
        ...
        <asp:Repeater ID="rptNews" runat="server">
            ...
            <ItemTemplate>
                 <tr>
                    ...
                    <td align="center">
                        <a href="SetNews.aspx?NewsId=<%#Eval("Id")%>">修改</a>
    ...
    <asp:Panel ID="pnlNoData" runat="server"  >
       ...
       <div id="div_NoDataMessage" style="text-align:center;  margin-top:75px; margin-bottom:75px;">暂无<span lang="zh-cn">最新动态信息</span></div>
    </asp:Panel>
 <cc2:ExportPageInfo ID="ExportPageInfo1" LinkType="4"  runat="server"></cc2:ExportPageInfo>
    ...
    <script type="text/javascript">
     function IsIE6()
     {
        ...
        {
         window.location.href="/EShop/SetNewsList.aspx";
        }        
     }
   //是否置顶操作
   function setTop(istop,news_id)   
   {
        $.ajax
        ({  
            url:"AjaxListIsTop.aspx?Id="+news_id+"&DataType=News&IsTop="+istop,
            cache:false,
            async:false,
   ...
   {  
     ...
     $.ajax
        ({  
            url:"AjaxListDelete.aspx?Id="+news_id+"&DataType=News",
            cache:false,
            async:false,
            success:function(msg)
            {
