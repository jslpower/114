...
namespace UserBackCenter.TeamService
{
    ...
    /// 创建人：柴逸宁  
    /// 2011-12-23
    public partial class ScatterPlanI : BackPage
    {
        /// <summary>
        /// 图片路劲根目录
        /// </summary>
        ...
        /// 线路区域类型
        /// </summary>
        protected AreaType areaType = AreaType.国际线;
        /// <summary>
        /// 出发地ID
        /// </summary>
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            Key = "ScatterPlanI" + Guid.NewGuid().ToString();
            #region 用户控件配置
            ILine1.Key = Key;
            ILine1.SelectFunctionName = "ScatterPlanI.GetList";
            ILine1.Title = "国际线路";
