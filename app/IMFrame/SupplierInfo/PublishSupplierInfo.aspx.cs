...
namespace IMFrame.SupplierInfo
{
    ...
    /// 创建人：曹胡生
    /// </summary>
    public partial class PublishSupplierInfo : EyouSoft.ControlCommon.Control.MQPage
    {
        ...
        private void Post()
        {
            ...
            {
                EyouSoft.Common.Function.MessageBox.ResponseScript(this, "document.getElementById(\"showMsg\").innerHTML=\"请输入供应内容\";");
                return;
            }
            if (content.Value.Length > 500)
            {
                EyouSoft.Common.Function.MessageBox.ResponseScript(this, "document.getElementById(\"showMsg\").innerHTML=\"供应内容最多500字\";");
                return;
            }
