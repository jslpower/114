<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PublishQiuGou.aspx.cs"
    Inherits="IMFrame.SupplierInfo.PublishQiuGou" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function post_onclick() {
            var InputNum=500-document.getElementById("content").value.length;
            if(InputNum==500){
                document.getElementById("showMsg").innerHTML="请输入求购内容";
                return false;
            }
            if(InputNum<0){
                document.getElementById("showMsg").innerHTML="求购内容最多500字";
                return false;
            }
        }
    </script>
