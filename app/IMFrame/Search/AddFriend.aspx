<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddFriend.aspx.cs" Inherits="IMFrame.Search.AddFriend" %>
    ...
    <script type="text/javascript">
        ...
        <script type="text/C#" runat="server">
            ...
            protected int GetUCount()
            {
                ...
                if (model != null)
                {
                    ucount = model.MQUser + model.MQUserVirtual;
                }
                model = null;
            ...
            protected string GetProvinceName()
            {
                ...
                int pid = Utils.GetInt(Request.QueryString["ProvinceId"]);

                if (pid > 0)
                {                    
                    EyouSoft.Model.SystemStructure.SysProvince pinfo= EyouSoft.BLL.SystemStructure.SysProvince.CreateInstance().GetProvinceModel(pid);
                    if (pinfo != null)
                    {
                        s = string.Format("您当前正在查看的是<b>{0}</b>旅游企业，", pinfo.ProvinceName);
                        pinfo = null;  
                    }
                }
        ...
        <tr>
            <td align="left" valign="top">
                ...
                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        <td width="27%" height="31" align="left" valign="bottom">
                            <a href="searchfriend.aspx">
                                <img src="<%= ImageServerUrl %>/IM/images/search2.gif" alt="点击搜索更多更全旅游企业" width="99" height="26" border="0" /></a>
                        </td>
                        <td width="73%" valign="bottom">
                            <!--您所在的浙江省共有50人在线，--><%=GetProvinceName() %>当前平台用户人数<%=GetUCount() %>人
                        </td>
                    </tr>
                    <tr>
