...
var HomeBigImages={
    init:function(width,count){
        function Each(list, fun) {
            for (var i = 0, len = list.length; i < len; i++) { fun(list[i], i); }
        };
        var objs2 = document.getElementById("idNum").getElementsByTagName("li");

        var tv2 = new TransformView("idTransformView", "idSlider", width, count, {
        ...
        var objs3 = document.getElementById("idSlider").getElementsByTagName("li");
