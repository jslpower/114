<%@ Page Title="团队信息" Language="C#" MasterPageFile="~/master/T4.Master" AutoEventWireup="true"
    CodeBehind="TourDetail.aspx.cs" Inherits="SeniorOnlineShop.template4.TourDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadPlaceHolder" runat="server">
    <style>
        ...
        #divAllTourList table{border:solid 1px #E3E3E3; border-collapse:collapse;}
        #divAllTourList tr{border:solid 1px #E3E3E3;}
        #divAllTourList td{border:solid 1px #E3E3E3;background-color:White;}
        .boxy-wrapper .title-bar h2{ color:Black;}
    </style>
</asp:Content>
    ...
    <div class="rightn">
        <div class="newsdetail2" style="margin: 0px;">
            ...
            <div class="trl_xin">
                ...
                <div class="trl_right">
                    <ul>
                        <li class="diyigeli">市 场 价： 
                          <span class="huang16"><asp:Literal ID="LitRetailPrices" runat="server"></asp:Literal></span>元/人起
                          <%=MQUrlHtml %>
                        </li>
                        <li id="liDjShowOrHiden" runat="server">
                             订金：成人 <span class="STYLE1"><asp:Literal ID="LitAdultPriceDj" runat="server"></asp:Literal></span>元 
                                  儿童 <span class="STYLE1"><asp:Literal ID="litChildrenPriceDj" runat="server"></asp:Literal></span>元       
                        </li>
                        <li>旅游主题：
                           <%=themeList.ToString() %>
                        </li>
                        ...
                        <li>往返说明：<asp:Literal ID="litStartTriffic" runat="server"></asp:Literal>&nbsp
                            <span style="margin-left:55px;"><asp:Literal ID="litEndTriffic" runat="server"></asp:Literal></span></li>
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0" class="maint10" style="float: left;">
                <tr>
                    <td style="border: 2px solid #FFC267; padding: 15px;">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0" id="planInfo" runat="server">
                            ...
                            <tr>
                                ...
                                <td width="44%" valign="middle" class="px14" style="border-bottom: 1px dashed #ccc;
                                    ...
                                    <span style="float: left; padding-right: 5px; cursor:pointer;" id="spanOrderTour" runat="server">
                        ...
                        <asp:Panel ID="panshowMsg" runat="server"  Visible="false">暂无计划信息!</asp:Panel>
                    </td>
                </tr>
            </table>
            <a name="t1"></a>
            ...
            <div class="trl_d_anpai">
                <strong>费用包含：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Label ID="lblServiceStandard" runat="server"></asp:Label></div>
            <div class="trl_d_anpai">
                <strong>费用不包含：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Literal ID="lblServiceStandardNo" runat="server"></asp:Literal>
            </div>
            <div class="trl_d_anpai">
                <strong>儿童及其他安排：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Label ID="lblAdultAndOtherPlan" runat="server"></asp:Label></div>
            <div class="trl_d_anpai">
                <strong>赠送项目：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Literal ID="LitPresentedProject" runat="server"></asp:Literal>
            </div>
            <div class="trl_d_anpai">
                <strong>自费项目：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Literal ID="LitCopaymentsProject" runat="server"></asp:Literal>
            </div>
            <div class="trl_d_anpai">
                <strong>购物点：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
                <asp:Literal ID="LitShoppingPlace" runat="server"></asp:Literal>
            </div>
            <div class="trl_d_anpai">
                <strong>备注信息：</strong></div>
            <div style="padding: 10px; line-height: 18px;">
        ...
        <script type="text/javascript">
            function AddOrder(TourId) {
                if ("<%=IsLogin %>" == "False") {
                    Boxy.iframeDialog({ title: "马上登录同业114", iframeUrl: "<%=GetLoginUrl(" + TourId + ") %>", width: "400px", height: "250px", modal: true });
                } else {
                    if ("<%=Role %>" == "1") { //专线身份
           ...
           $(function() {
               ...
               $(".SanKeYD").click(function() {
                   ...
                   if ("<%=IsLogin %>" == "False") {
                       ...
                       if ("<%=Role %>" == "3") { //其它身份
                           window.location.href = "<%=EyouSoft.Common.Domain.UserBackCenter %>/Default.aspx?tourID=" + TourId + "&adult=" + adult + "&child=" + child + "&contact=" + contact + "&tel=" + tel;
                       }
                   }
                   return false;
               });
               ...
               $("#<%=DropPowerList.ClientID %>").change(function() {
                   ...
                   $.ajax({
                       type: "GET",
                       url: "/template4/TourDetail.aspx?tourid=" + tourID + "&t=1&cid=" + cid,
                       cache: false,
                       dataType: "json",
