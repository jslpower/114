<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxLineTravelagencyList.aspx.cs" Inherits="SiteOperationsCenter.Statistics.AjaxLineTravelagencyList" %>
<%@ Import Namespace="EyouSoft.Common" %>
<%@ Register Assembly="ControlLibrary" Namespace="Adpost.Common.ExporPage" TagPrefix="cc2" %>

<%@ Register Assembly="ControlLibrary" Namespace="ControlLibrary" TagPrefix="cc1" %>

<cc1:CustomRepeater ID="crpTravelagencyList" runat="server">
  <HeaderTemplate>
  ...
  <tr background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" class="white" height="23">
    <td width="6%" align="center" valign="middle" background="<%=ImageServerUrl %>/images/yunying/hangbg.gif">
    <strong>序号</strong>
    </td>
    ...
    <td width="15%" align="center" valign="middle" background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif"><STRONG>最后登录时间</STRONG></td>
   
    <td width="8%" align="center" valign="middle" background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif"><strong>登录次数</strong></td>
  </tr>
    </HeaderTemplate>
    <ItemTemplate>
    ...
    <td align="center"><%# ((EyouSoft.Model.CompanyStructure.CompanyDetailInfo)GetDataItem()).StateMore.LastLoginTime %></td>
