<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="LinksInfo.aspx.cs" Inherits="SiteOperationsCenter.PlatformManagement.LinksInfo" %>
   ...
   <script type="text/javascript" src="<%=JsManage.GetJsFilePath("boxy") %>"></script>--%>
    ...
    <script language="JavaScript">
        ...
        function GetChkValue() {
            var arr = new Array();
            var jQueryObj = $("#rpt_LinkList tr input[type='checkbox']");
        ...
        function OnEditSubmit() {
            ...
            var Url = "OperatorLink.aspx?linkType=<%=LinkType%>&EditID=";
            var arr = GetChkValue();
...
<body>
            ...
            <td width="30%" height="25" background="<%=ImageServerUrl%>/images/yunying/gongneng_bg.gif">
                <table width="99%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                        ...
                        <td width="11%">
                            <a href="OperatorLink.aspx?linkType=<%=LinkType%>">
                        ...
                        <td width="11%">
                            <img src="<%=ImageServerUrl%>/images/yunying/xiugai.gif" width="50" height="25" border="0"
                                style="cursor: hand" onclick="OnEditSubmit();" />
                        </td>
                        <td width="2%">
                            <img src="<%=ImageServerUrl%>/images/yunying/ge_hang.gif" width="2" height="25" />
                        </td>
    ...
    <asp:Repeater ID="rpt_LinkList" runat="server" OnItemDataBound="rpt_LinkList_ItemDataBound">
        <HeaderTemplate>
            <table width="98%" id="rpt_LinkList" border="0" align="center" cellpadding="0" cellspacing="1"
                class="kuang">
                <tr background="<%=ImageServerUrl%>/images/yunying/hangbg.gif" class="white" height="23">
                    <td width="9%" align="center" valign="middle" background="<%=ImageServerUrl%>/images/yunying/hangbg.gif">
                        <strong>
                            <input type="checkbox" onclick="CheckAll(this)" />序号</strong>
                    </td>
    ...
    <asp:Panel ID="NoData" runat="server" Visible="false">
        <table width="98%" border="1" align="center" cellpadding="0" cellspacing="1" class="kuang">
            <tr background="<%=ImageServerUrl%>/images/yunying/hangbg.gif" class="white" height="23">
                <td width="9%" align="center" valign="middle" background="<%=ImageServerUrl%>/images/yunying/hangbg.gif">
                    <strong>
                        <input type="checkbox" onclick="CheckAll(this)" />序号</strong>
