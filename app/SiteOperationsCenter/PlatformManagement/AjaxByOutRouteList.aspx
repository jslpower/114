<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxByOutRouteList.aspx.cs"
    Inherits="SiteOperationsCenter.PlatformManagement.AjaxByOutRouteList" %>

<%@ Import Namespace="EyouSoft.Common" %>
<table width="100%" border="0" align="center" cellpadding="1" cellspacing="1" >
  <tr charoff="2">
    <td width="131" height="23" align="right" bgcolor="#C3E3F2"><strong>出境短线</strong>：</td>
...
<script type="text/javascript">
    $(document).ready(function() {
        $(".add_btn").click(function() {
            var title = "专线区域添加";
            var url = "/PlatformManagement/AddLineArea.aspx?Action=EN";
            Boxy.iframeDialog({ title: title, iframeUrl: url, height: 300, width: 600, draggable: false });
            return false;
        });
        $(".updateRouteAreaP").click(function() {
            var title = "专线区域修改";
