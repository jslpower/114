<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QueryTour.aspx.cs" Inherits="SiteOperationsCenter.LineManage.QueryTour" %>
...
<body>
    ...
    <script type="text/javascript" language="javascript">
        ...
        function query() {
            ...
            if (type == "new") {
                window.location.href = "QueryTour.aspx?CompanyName=" + encodeURI(companyName) + "&Province=" + $("#ProvinceAndCityList1_ddl_ProvinceList").val() + "&City=" + $("#ProvinceAndCityList1_ddl_CityList").val() + "&NeedId=" + NeedId + "&AeraID=<%=Request.QueryString["AeraID"] %>&type=<%=Request.QueryString["type"] %>&backCallFun=<%=Request.QueryString["backCallFun"] %>&key=<%=Request.QueryString["key"] %>&iframeId=<%=Request.QueryString["iframeId"] %>";
            } else {
                window.location.href = "QueryTour.aspx?CompanyName=" + encodeURI(companyName) + "&Province=" + $("#ProvinceAndCityList1_ddl_ProvinceList").val() + "&City=" + $("#ProvinceAndCityList1_ddl_CityList").val() + "&NeedId=" + NeedId;
            }
        }
        $(function() {
            $("#btnSelect").click(function() {
                ...
                if (type != "new") {
                    ...
                    if (selectObj.length > 0) {
                        ...
                        parent.window[backCallFun](data, '2');
                        closeWin();
                    } else {
                        alert("请选择！");
                    }
