<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SetTourNo.aspx.cs" Inherits="SiteOperationsCenter.LineManage.SetTourNo" %>
...
<body>
    ...
    $("#btnSave").click(function(){
        ...
        {    
            ...
            $.ajax({
	                type:"POST",
	                url:"/LineManage/SetTourNo.aspx?flag=save&AreaId=<%=AreaId%>&CompanyId=<%=CompanyId%>&PrefixText="+ encodeURI(arr.join(',')) +"&AreaIdList="+ encodeURI(arrAreaId.join(',')) +"&rnd="+ Math.random(),
	                cache:false,
