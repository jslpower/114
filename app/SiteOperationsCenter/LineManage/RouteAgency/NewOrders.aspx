<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewOrders.aspx.cs" Inherits="SiteOperationsCenter.LineManage.NewOrders" %>
         ...
         <table id="tbl_arealist" cellspacing="0" cellpadding="0" border="0" align="center" class="toolbj1" style="width:100%;">
           ...
           <tr>
             ...
             <asp:Repeater runat="server" ID="rptAreaList">
               <ItemTemplate>
               <a class="select" href="javascript:void(0);" ref="<%#Eval("AreaId") %>"><%#Eval("AreaName")%></a> 
               </ItemTemplate>
             </asp:Repeater>
             </td>
           </tr>
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="center" style="margin-top:5px; margin-bottom:3px;">
           ...
           <tr>
             ...
             <td width="95%" style="padding:5px;"><table width="100%" cellspacing="0" cellpadding="1" bordercolor="#9dc4dc" border="1" align="center" class="liststyle">
                 ...
                 <%#GetOrderListByTourID(Eval("Orders"))%>
             </tbody></table></td>
           </tr>
            </ItemTemplate>
           </asp:Repeater>
    ...
    <td align="left"><strong>答</strong>：订单取消权限在组团社，请通知联系组团社，由组团社手动取消。</td>
       ...
       <script type="text/javascript">
           ...
           var NewOrders = {
               areaID: "<%=areaID %>",
               SearchFun: function() {
                   var para = { areaID: "", serachKey: "", dateBegin: "", dateEnd: "" };
                   para.areaID = $("#<%=tblID %>").find("[id$=<%=ddlAreaList.ClientID %>]").val();
                   para.serachKey = $.trim($("#<%=tblID %>").find("[id$=<%=txtSearchKey.ClientID %>]").val());
           ...
           $(function() {
               ...
               $("#<%=tblID %>").find("#tbl_arealist").find("a").each(function() {
                   if ($(this).attr("ref") == NewOrders.areaID) {
