<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UnitAdList.aspx.cs" Inherits="SiteOperationsCenter.AdManagement.UnitAdList" %>
...
<body>
  ...
  <table width="98%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
     <tr style="height:30px;">
                <td align="center">
                    <h3>
                        <asp:Literal ID="ltr_Menu" runat="server"></asp:Literal></h3>
                </td>
            </tr>
      <td background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/chaxunbg.gif">
          ...
          runat="server" class="style1"></span><uc1:ProvinceAndCityList ID="ProvinceAndCityList1" runat="server" /><span lang="zh-cn">购买单位：</span>
        <input name="txtUnitName" type="text" class="style7" size="12" id="txtUnitName" 
              runat="server"/>&nbsp;
        <a href="javascript:void(0)" id="btnSearch"><img  src="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/chaxun.gif" width="62" height="21" style="margin-bottom:-3px;" /></a>
       </td>
    </tr>
  </table>
  <table width="98%"  border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      <td width="23%" height="25" background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/gongneng_bg.gif" ><table width="51%"  border="0" cellspacing="0" cellpadding="0">
           <tr>
            ...
            <td class="style1">
            <a href="javascript:void(0)" id="hrefDelete"><img src="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/shanchu.gif" width="51" height="25" /></a></td>
  ...
  <tr background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" class="white">
    ...
    <td align="center" 
          background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" 
          class="style9"><strong>广告位置</strong></td>
           <td align="center" 
          background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" 
          class="style9"><strong>广告图片</strong></td>
    <td align="center" 
          background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" 
          class="style5"><strong>购买单位</strong></td>
    <td align="center" 
          background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" 
          class="style12"><strong>联系方式</strong></td>
    <td align="center" 
          background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif" 
          class="style11"><strong>投放城市</strong></td>
    <td align="center" background="<%=ImageManage.GetImagerServerUrl(1)%>/images/yunying/hangbg.gif"><strong>有效期</strong>
    </td>
</tr>
        ...
        <input type="hidden" id="sort<%#Eval("AdvId") %>" value="<%#Eval("SortId") %>" />
                ...
                <td align="left">
                        <a href="<%=Domain.FileSystem %><%#Eval("ImgPath").ToString() %>" target="_blank">
                            <img  width="106"  height="55" src='<%=Domain.FileSystem %><%#Eval("ImgPath").ToString() %>'/>
                        </a>
                    </td>
       ...
       $(document).ready(function()
        {  
            ...
            $("#hrefUpdate").click(function()
            {
                if("<%=IsUpdateGant %>".toLowerCase()=="true")
               {
                    ...
                    if(advid!=-1)
                    {
                         $(this).attr("href","<%=PagePath %>AdvId="+IsSelectAdv());
                    }else{
                        alert("请选择一项！");
                        return false;
                    }
        ...
        function OnLoadPage(opear)
        {
            ...
            {          
              ...
              return "UnitAdList.aspx?unit="+companyName+"&province="+provinceid+"&city="+cityid+"&start="+start+"&end="+end+"&position="+StartPosition;
        }
