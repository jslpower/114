...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Link','Unlink','Anchor'],
	['Table','Rule','Smiley','SpecialChar','PageBreak','Image'],
	'/',
...
*/
FCKConfig.ToolbarSets["UserInfo"] = [
...
FCKConfig.ToolbarSets["NewsInfo"] = [
	['Source','DocProps','-','Preview','-','Image'],
	['Cut','Copy','Paste','PasteText','PasteWord','-','Print'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
...
FCKConfig.ToolbarSets["Basic"] = [
	['Bold','Italic','OrderedList','UnorderedList','Smiley','Cut','Copy','Paste','PasteText','PasteWord']
] ;
FCKConfig.ToolbarSets["EditNews"] = [
	['Source','Bold','Italic','OrderedList','UnorderedList','Cut','Copy','Paste','PasteText','PasteWord', 'Image', 'Smiley'],
	'/',
