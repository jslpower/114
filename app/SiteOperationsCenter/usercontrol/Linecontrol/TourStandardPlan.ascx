<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TourStandardPlan.ascx.cs"
    Inherits="SiteOperationsCenter.usercontrol.Linecontrol.TourStandardPlan" %>
<table width="96%" border="1" align="center" cellpadding="0" cellspacing="0" class="lankuang"
    ...
    <%=tmpStandardPlan%>
    <asp:HiddenField ID="hidarrTraffic" runat="server" />
</table>
...
<script type="text/javascript">
    var TourStandardPlan = {  
        ...
        AddDateInfo: function(initmodel,id) {//新增行
            ...
            var arrTraffic = ["飞机","大巴","火车","轮船","不包含","其它"];
            var PlanInterval = "", TrafficNumber = "", House = "", PlanContent = "", Early = false,Center = false,Late = false;
            if(initmodel != null)
            {
                ...
                Early=initmodel.Early;
                Center=initmodel.Center;
                Late=initmodel.Late;
            ...
            trString += "</td>";
            trString += "<td  class='zhonglan_l'>途径：<input name=\"SightArea" + Index + "\" class=\"input\" size='12' type=\"text\" id=\"SightArea\" value=\""+ PlanInterval +"\">";
            trString += "</td>";
...
//            trString += "</td>";
            ...
            trString += "<input name=\"DinnerPlanEarly" + Index + "\" type=\"checkbox\" id=\"DinnerPlanEarly"+Index+"\" value=\"早\" "+ oneChecked +">&nbsp;早&nbsp;";
            trString += "<input name=\"DinnerPlanCenter" + Index + "\" type=\"checkbox\" id=\"DinnerPlanCenter"+Index+"\" value=\"中\" "+ twoChecked +">&nbsp;中&nbsp;";
            trString += "<input name=\"DinnerPlanLate" + Index + "\" type=\"checkbox\" id=\"DinnerPlanLate"+Index+"\" value=\"晚\" "+ threeChecked +">&nbsp;晚&nbsp;";
            trString += "</td>";
            //操作列 删除
