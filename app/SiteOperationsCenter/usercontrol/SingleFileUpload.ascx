<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SingleFileUpload.ascx.cs"
    Inherits="SiteOperationsCenter.usercontrol.SingleFileUpload" %>
...
<script type="text/javascript">
		...
		<%=this.ClientID %> = new SWFUpload({
				    // Backend Settings
				    upload_url: "<%=Domain.FileSystem %>/SiteOperation/upload.aspx",
				    ...
				    file_types : "*.jpg;*.png;*.gif;*.bmp;*.jpeg;<%=!_IsUploadSwf?"":"*.swf" %>",
