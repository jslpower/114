...
<asp:Content ContentPlaceHolderID="Main" ID="Default_ctMain" runat="server">
    ...
    <div class="body">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
            <tr>
                <td align="center">
                    <img id="RegisterHeadimg" src="<%=ImageServerPath %>/images/UserPublicCenter/join-1.gif" width="956" height="30" />
                </td>
            </tr>
        </table>
        ...
        <div id="divFristRegister">
            <table width="940" border="0" cellspacing="0" cellpadding="5" class="maintop15">
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <input id="txtCompanyName" name="txtCompanyName" type="text" class="bitian" size="50" valid="required" errmsg="请填写公司名称!" />
                                </td>
                                <td>
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="11%">
                                    <input id="txtFristPassWord" name="txtFristPassWord" type="password" class="bitian" size="20" />
                                </td>
                                <td width="89%">
                                    <div class="tist" style="display:none">
                                        <img src="<%=ImageServerPath %>/images/UserPublicCenter/1000716.gif" width="16" height="16" />
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="11%">
                                    <input  id="txtSecondPassWord" name="txtSecondPassWord" type="password" class="bitian" size="20" />
                                </td>
                                <td width="89%">
                                    <div class="tist" style="display:none">
                                        <img src="<%=ImageServerPath %>/images/UserPublicCenter/1000716.gif" width="16" height="16" />
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                  ...
                  <a title="刷新验证码" href="#" onclick="javascript:document.getElementById('<%=imgValidateCode.ClientID %>').src='/ValidateCode.aspx?ValidateCodeName=CompanyRegisterCode&id='+Math.random();$('#spanCodeisNull').hide();return false;"><asp:Image ID="imgValidateCode" runat="server" /></a>
            ...
            <table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr>
                    <td align="left">
                        <input id="F_ckPact" name="checkbox" type="checkbox" value="checkbox" checked="checked" />
                        <label for="F_ckPact" style="cursor:pointer"> 阅读并同意以下条款</label> <br />
...
本服务条款之解释与适用，以及与本服务条款有关的争议，均应依照中华人民共和国法律予以处理，并以浙江省杭州市西湖区人民法院为第一审管辖法院。
        ...
        <div id="divSecondRegister" >
            <table width="940" border="0" cellspacing="0" cellpadding="5" class="maintop15">
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <span style="font-size: 16px;">杭州天目旅行社</span>
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="11%">
                                    <input name="textfield2" type="text" class="bitian2" size="20" />
                                </td>
                                <td width="89%">
                                    &nbsp;
                                </td>
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td width="11%">
                                    <input  id="S_txtBrandName" name="txtBrandName" type="text" class="bitian1" size="20" />
                                </td>
                                <td width="89%">
                                    &nbsp;
                                </td>
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <input name="textfield222" type="text" class="bitian1" size="50" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                    ...
                    <td align="left">
                        <input name="textfield2222" type="text" class="bitian2" size="50" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                    ...
                    <td align="left">
                        程序员注意！选中单选前，多选为灰，选中后颜色变正常
                        <table width="400" border="0" cellspacing="0" cellpadding="2" style="border: 1px solid #D1E7F4;
                            background: #F2FAFF">
                            <tr>
                                <td width="25%" align="left">
                                    <input type="radio" name="radiobutton" value="radiobutton" /><strong style="color: #3366CC">旅行社</strong>
                                </td>
                                <td width="25%" align="left">
                                    <input type="checkbox" name="checkbox2" value="checkbox" />组团社
                                </td>
                                <td width="25%" align="left">
                                    <input type="checkbox" name="checkbox22" value="checkbox" />专线商
                                </td>
                                <td width="25%" align="left">
                                    <input type="checkbox" name="checkbox23" value="checkbox" />地接社
                                </td>
                            </tr>
                            <tr>
                                <td align="left">
                                    <input type="radio" name="radiobutton" value="radiobutton" /><strong style="color: #3366CC">景区</strong>
                                </td>
                                <td align="left">
                                    &nbsp;
                                </td>
                            ...
                            <tr>
                                <td align="left">
                                    <input type="radio" name="radiobutton" value="radiobutton" /><strong style="color: #3366CC">车队</strong>
                                </td>
                                <td align="left">
                                    &nbsp;
                                </td>
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <input name="textfield223" type="text" class="bitian2" size="20" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                    ...
                    <td align="left">
                        <input name="textfield2232" type="text" class="bitian1" size="20" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                    ...
                    <td align="left">
                        <input name="textfield2234" type="text" class="bitian1" size="20" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <input name="textfield2235" type="text" class="bitian1" size="20" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                ...
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    ...
                    <td align="left">
                        <input name="textfield22352" type="text" class="bitian2" size="20" />
                    </td>
                </tr>
                <tr onmouseover="mouseovertr(this)" onmouseout="mouseouttr(this)">
                    <td align="right">
                    ...
                    <td align="left">
                        <input name="textfield22353" type="text" class="bitian2" size="20" />
                    </td>
                </tr>
                <tr>
                    <td height="40" align="right">
                    ...
                    <td align="left">
                            <input type="submit" id="btnSecondRegister" value="资料填写完成！提交并进入系统" style="background: url(<%=ImageServerPath %>/images/UserPublicCenter/subb.gif);
                            width: 270px; height: 37px; border: none; font-size: 14px; font-weight: bold;
                            color: #ffffff; cursor:pointer"  />
                    </td>
                </tr>
    ...
    <script type="text/javascript">
        var Register = {
            ...
            ckInputisNull: function($obj, isOnclick) {
                ...
                if (objValue != "") {
                    ...
                    if (objId == "txtUserName") {
                        ...
                        alert(objValue + ":" + (/^[\d]*$/g.test(objValue)) + "|" + (/^[a-z]*$/gi.test(objValue)) + "|" + (/[\u4E00-\u9FA5a-z0-9\s]/gi.test(objValue)));
                        //不能为纯数字，纯字母，纯符号
                        if ((/^[\d]*$/g.test(objValue)) || (/^[a-z]*$/gi.test(objValue)) || (/^[\u4E00-\u9FA5a-z0-9\s]*$/gi.test(objValue))) {
                            $obj.parent("td").next().find("div").show();
                            return false;
                        }
                    }
...
//                    $.ajax
//                    ({
//                        url: "AjaxCheckVisidate.aspx?validNumber=" + $.trim($CodeObj.val()) + "&CookieName=MSMValidateCode&rnd=" + new Date().getTime(),
//                        cache: false,
//                        async: false,
...
//                        }
                    ...
                    for (var i = 0; i < arrStrCookie.split(";").length; i++) {
                        var tem = arrStrCookie[i].split("=");
                        if (tem[0] == "CompanyRegisterCode") {
                            if (tem[1] == $.trim($CodeObj.val())) {
                                validResult = true;
                            }
                        }
                    }
        ...
        $(function() {
            ...
            //            FV_onBlur.initValid($("#btnFristRegister").closest("form").get(0));
            ...
            $("#btnFristRegister").click(function() {
                $("#divFristRegister .bitian").each(function() {
                    Register.ckInputisNull($(this), true);
                });
                Register.ckValidateCode();
            });
