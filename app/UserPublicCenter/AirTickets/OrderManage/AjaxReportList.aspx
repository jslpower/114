<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AjaxReportList.aspx.cs" Inherits="UserPublicCenter.AirTickets.OrderManage.AjaxReportList" %>
...
<ItemTemplate>
      <tr>
            <td height="30" align="center"><a href='OrderDetails.aspx?OrderId=<%#Eval("OrderId") %>'><%#Eval("OrderNo")%></a></td>   
...
<FooterTemplate>     
  ...
  <td colspan="13" height="30" align="center">   
       <a  href="ReportToExcel.aspx?StartTime=<%=startTime%>&EndTime=<%=endTime %>&Year=<%=year%>&Month=<%=month%>&Stats=<%=stats%>&Type=<%=Type%>" 
