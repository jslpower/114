<%@ Page  Language="C#" MasterPageFile="~/MasterPage/AirTicket.Master" AutoEventWireup="true" CodeBehind="Return_url.aspx.cs" Inherits="UserPublicCenter.AirTickets.Return_url" %>
...
<myASP:TopMenu id="ts_ucTopMenu" runat="server" TabIndex="tab5"></myASP:TopMenu>
 <div class="sidebar02_con">
      <div class="sidebar02_con_table03">
        ...
        <%--  <tr>
            <th height="45" align="right">买家账号：</th>
            <td align="left">&nbsp;</td>
            <td align="left"><span class="font_red"><%= buyerAccount %></span></td>
          </tr>--%>
          <tr>
