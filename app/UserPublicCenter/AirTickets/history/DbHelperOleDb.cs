...
namespace UserPublicCenter.AirTickets.history
{
    public class DbHelperOleDb
    {
        ...
        public static string connectionString = "Provider=Microsoft.Jet.OLEDB.4.0;Persist Security Info=True;Data Source=" + HttpContext.Current.Server.MapPath("~/App_Data/jipiao/historyOrder.mdb");

        public DbHelperOleDb()
        {
        }

        static DbHelperOleDb()
        {
