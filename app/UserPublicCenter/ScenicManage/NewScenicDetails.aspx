            ...
            <td width="735" valign="top">
                <div class="content">
                    <div class="jieshao">
                        ...
                        <a href="<%=Utils.GetNewImgUrl(result!=""?result.Split('$')[1]:"",3) %>" target="_blank" title="<%=result!=""?result.Split('$')[2]:"暂无" %>">
                            <img src="<%=Utils.GetNewImgUrl(result!=""?result.Split('$')[0]:"",3) %>" width="250" height="190"  onerror="this.src='<%=Utils.GetNewImgUrl("",2)%>';"/>
                        </a>
                        </div>
                        <ul>
                            <li><span class="a3a3a">所属地区:</span><%=ScenicModel.ProvinceName %>
                            ...
                            <li title="<%=ScenicModel.CnAddress %>"><span class="a3a3a">景区地址:</span><%=Utils.GetText2(ScenicModel.CnAddress,20,true)%></li>
                            ...
                            <li title="<%=ScenicModel.OpenTime %>"><span class="a3a3a">开放时间:</span><%=Utils.GetText2(ScenicModel.OpenTime,20,true)%></li>
                        </ul>
                    </div>
