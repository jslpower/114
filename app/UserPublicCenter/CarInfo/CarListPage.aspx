<%@ Page Language="C#" AutoEventWireup="true" EnableEventValidation="false" Title="车队"
    MasterPageFile="~/MasterPage/PublicCenterMasterPage.Master" CodeBehind="CarListPage.aspx.cs"
    Inherits="UserPublicCenter.CarInfo.CarListPage" %>
                ...
                <div class="goulefthx">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                            ...
                            <td style="width: 73%">
                                <asp:TextBox ID="txt_CompanyName" runat="server" Style="line-height: 18px; height: 18px;
                                    width: 160px; color: #999; border: 1px solid #7E9DB0;"></asp:TextBox>
                                    ...
                                    <td align="left">
                                        ...
                                        <div class="gouwunei">
                                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="huise">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        主要优势：<%#GetContentRemark(Convert.ToString(DataBinder.Eval(Container.DataItem, "ShortRemark")),10)%>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="2">
                                                ...
                                                <tr>
                                                    <td colspan="2">
                                                        介绍：<%#GetContentRemarkTwo(DataBinder.Eval(Container.DataItem, "Remark").ToString(),12)%>
                                                    </td>
                                                </tr>
                                            </table>
                                        </div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var params = { CompanyName: encodeURIComponent($("#<%=txt_CompanyName.ClientID %>").val()), ProvinceID: $("#ctl00_Main_ProvinceAndCityList1_ddl_ProvinceList").val(), S_CityID: $("#ctl00_Main_ProvinceAndCityList1_ddl_CityList").val(), CityId: "<%=CityId %>" };
                ...
                window.location.href = "/CarInfo/CarListPage.aspx?" + str;
            });
