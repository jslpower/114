<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QGroupActivation.aspx.cs" Inherits="UserPublicCenter.SupplierInfo.QGroupActivation" MasterPageFile="~/SupplierInfo/SupplierNew.Master" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="SupplierBody" runat="server">
    ...
    <div style="width: 68.59%" id="supply-right" class="addVg">
        ...
        <div class="news-read">
            <div class="title">
                <h2><%=QGroupMessageInfo.Title%></h2>
                <p>
                    <span><%=QGroupMessageInfo.IssueTime.ToString("yyyy年MM月dd日 HH:mm")%></span>
                    <span><a href="?activationid=<%=activationid %>&a=1">立即激活</a></span>
                </p>
            </div>
            <div class="content" id="jcontent">
                <%= UserPublicCenter.SupplierInfo.SupplierCom.ConvertExchangeListContent(QGroupMessageInfo.Content)%>
