    ...
    public partial class CityAndMenu : System.Web.UI.UserControl
    {
        ...
        public int HeadMenuIndex
        {
            get
            {
                ...
                {   
                    UserPublicCenter.MasterPage.NewPublicCenter master;
                    UserPublicCenter.SupplierInfo.SupplierNew masterNew= this.Page.Master as  UserPublicCenter.SupplierInfo.SupplierNew;
                    if (masterNew != null)
                    {
                        master = masterNew.Master as UserPublicCenter.MasterPage.NewPublicCenter;
                    }
                    else
                    {
                        master = this.Page.Master as UserPublicCenter.MasterPage.NewPublicCenter;
                    }
                    if (master != null)
                    {
                        return master.HeadMenuIndex;
                    }
                    else
                    {
                        return 1;
