                    ...
                    <div class="gscp">
                        <ul>
                            <cc1:CustomRepeater ID="repTourList" runat="server">
                                <HeaderTemplate>
                                    <li class="gs_title"><span class="gs_xianlu">出发</span> <span class="gs_banci">线路</span>
                                        <span class="gs_tianshu">天数</span> <span class="gs_chengren">团队班次</span> <span class="gs_ertong">
                                            市场价</span> <span class="gs_caozuo">操作</span> </li>
                                </HeaderTemplate>
                                <ItemTemplate>
