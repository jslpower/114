...
{       
    ...
    public interface IUserLogin
    {
        ...
        /// <param name="PWD">用户密码</param>
        /// <returns></returns>
        UserInfo UserLoginAct(int MQID, string PWD);
        /// <summary>
        /// 用户退出
        /// </summary>
        ...
        /// <returns>用户信息</returns>
        UserInfo GetMQUserInfo(int MQID);
        /// <summary>
        /// 更新用户信息
        /// </summary>
    ...
    public interface IUserLoginService
    {
        ...
        SSOResponse GetTicketUser(string UserName, string LoginTicket);
        /// <summary>
        /// 用户登录
        /// </summary>
        /// <param name="UserName">用户名</param>
        ...
        /// <param name="UID">用户编号</param>
        /// <returns>用户信息</returns>
        SSOResponse GetUserInfo(string UID);
        /// <summary>
        /// 更新用户信息
        /// </summary>
        /// <param name="sso">sso信息</param>
        void UpdateUserInfo(SSOResponse sso);
    }
